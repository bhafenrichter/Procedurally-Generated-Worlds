using UnityEngine;
public class SimplexNoiseMap : _INoiseMap {
    ...
    public SimplexNoiseMap (int seed, int width, int height, float scale, float lacunarity, float persistance, int octaves) {
      this.seed = seed;
      this.width = width;
      this.height = height;
      this.scale = scale;
