...
{
  internal Texture2D BuildTexture(TerrainType[] terrainConfigs, float[,] heightMap)
  {
    int tileDepth = heightMap.GetLength(0);
    int tileWidth = heightMap.GetLength(1);

    Color[] colorMap = BuildPixelData(terrainConfigs, heightMap);
  ...
  internal Color[] BuildPixelData(TerrainType[] terrainConfigs, float[,] heightMap) {
